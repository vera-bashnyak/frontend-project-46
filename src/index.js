...
const genDiff = (filepath1, filepath2, formatName) => {
  ...
  const findDiff = (obj1, obj2) => {
    ...
    const arr = sortedEntries.flatMap((entry) => {
    ...
    if (value instanceof Object) {
      if (!Object.hasOwn(obj1, key)) {
        return obj = {name: key, status: 'added', value};
      } 
      
      else if (!Object.hasOwn(obj2, key)) {
        return obj = {name: key, status: 'deleted', value};
      } 
      ...
      return obj = {name: key, value: resultValue};
      } 
    } 
